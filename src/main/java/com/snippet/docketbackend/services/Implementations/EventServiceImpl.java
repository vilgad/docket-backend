...
public class EventServiceImpl implements EventService {
        ...
        public Response getSingleEventTemplate(String name, Long userId) {
                ...
                Optional<EventTemplate> event = eventRepo.findByName(name, user.get().getEmail());
        ...
        public Response getEventsByType(Long userId, String type) {
                ...
                List<EventTemplate> events = eventRepo.findByType(type, user.get().getEmail());
        ...
        public Response getEventByLinkName(Long userId, String linkName) {
                ...
                Optional<EventTemplate> event = eventRepo.findByLinkName(linkName, user.get().getEmail());
